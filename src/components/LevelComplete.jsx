...
export default function LevelComplete({
  ...
  const isLastLevel = Number(word.level) >= totalLevels;
    ...
    <main className="screen complete-screen">
      ...
      <section className="complete-content">
        ...
        <section className="complete-actions">
          <button className="action-replay" onClick={onReplay}>
            Replay
          </button>

          <button className="action-next" onClick={isLastLevel ? onMap : onNext}>
            {isLastLevel ? "Finish World" : "Next Level"}
          </button>

          <button className="action-map" onClick={onMap}>
            World Map
          </button>
        </section>
      </section>
